          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 transform transition-all duration-300 scale-100">
            <div className="flex items-center space-x-3 mb-4">
              <div className="flex items-center justify-center w-10 h-10 bg-red-100 rounded-xl">
                <Icons.Logout className="w-5 h-5 text-red-600" />
              </div>
              <div>
            ...
            <div className="flex space-x-3 mt-6">
              ...
              <button
                ...
                className="flex-1 px-4 py-2.5 text-white bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 rounded-xl font-medium shadow-sm transition-all duration-200 transform hover:-translate-y-0.5"
              >
                Logout
              </button>
            </div>
