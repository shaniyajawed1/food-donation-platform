  ...
  const features = [
    {
      ...
      description:
        "Restaurants and businesses easily list surplus food with details and photos",
      icon: icons.list,
    ...
    },
    {
      ...
      description:
        "Our AI-powered platform matches donations with nearby food banks and recipients",
      icon: icons.search,
    ...
    },
    {
      ...
      description:
        "Seamless coordination for timely pickup and distribution with real-time tracking",
      icon: icons.truck,
    ...
    <div className="min-h-screen bg-white">
      <section className="relative h-[90vh] w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-3xl">
          <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8 drop-shadow-lg">
          ...
          <p className="text-xl mb-12 leading-relaxed opacity-95">
            The smart platform that makes it easy to rescue surplus food and get
            it to those who need it most. Join thousands making a difference in
            their communities.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Link
              ...
              className="group border-2 border-white text-white px-10 py-5 rounded-2xl font-semibold hover:bg-white hover:text-blue-600 transform hover:scale-105 transition-all duration-300 hover:shadow-lg"
            >
              <span className="flex items-center justify-center gap-3">
                Find Food
                <svg
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                Turn your surplus food into meaningful impact. Join restaurants,
                caterers, and food businesses that are reducing waste while
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                Access fresh, nutritious food from local businesses. Food banks,
                shelters, and individuals can find available donations in their
                area.
              </p>
              <ul className="space-y-5 mb-12">
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 via-purple-600 to-green-500 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl mb-12 opacity-95 max-w-2xl mx-auto leading-relaxed">
            Join our community creating sustainable food solutions and building
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Connecting surplus food with communities in need. Building a
                sustainable future through technology and compassion.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 text-sm">
            <p>
              &copy; {new Date().getFullYear()} FeedTheNeed. All rights
              reserved. Making the world better, one meal at a time.
            </p>
          </div>
        </div>
      </footer>
